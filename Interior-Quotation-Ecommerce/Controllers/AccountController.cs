...
namespace Interior_Quotation_Ecommerce.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public IActionResult Login([FromBody] AccountsDTO loginInfo)
        {
        ...
        public IActionResult RefreshToken([FromBody] TokensDTO refreshTokenRequest)
        {
        ...
        [AllowAnonymous]
        [HttpPost("/api/v1/accounts/register/customer")]
        public IActionResult Register([FromBody] AccountsDTO newAccount)
        {
        ...
        public IActionResult RegisterContractor([FromBody] AccountsDTO newAccount)
        {
            if (string.IsNullOrEmpty(newAccount.Name))
            {
                return BadRequest("Full Name is required");
